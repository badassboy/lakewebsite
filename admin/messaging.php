...
if(isset($_POST['add'])){
  ...
  if(empty($customer)|| empty($subject)|| empty($message)){
    $msg = "fields are required";
  }else {
    $laliga = $ch->MessageCustomer($customer,$subject,$message);
    if($laliga){
      $msg = "<script>alert('Message Sent')</script>";
    }else {
      $msg = "<script>alert('Message Not Sent')</script>";
    }
  }
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            <label for="exampleInputPassword1">Subject</label>
             <input class="form-control" name="subject" rows="3" required placeholder="Subject">
